...
def parse_args():
    ...
    parser.add_argument("--dataset", nargs="?", default="aminer",
                        help="Choose a dataset:[amazon, aminer, gowalla, yelp2018]")
    parser.add_argument(
    ...
    parser.add_argument("--gnn", nargs="?", default="ApeGNN",
                        help="Choose a recommender:[lightgcn, ApeGNN]")
    ...
    parser.add_argument("--gs_l2", type=int, default=1, help="grid search l2")
